 ...
 * Use the {@link StatusSmsFragment#newInstance} factory method to
...
public class StatusSmsFragment extends Fragment {
    ...
    public StatusSmsFragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static StatusSmsFragment newInstance(String param1, String param2) {
        StatusSmsFragment fragment = new StatusSmsFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Status wysyłek Sms");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_status_sms, container, false);
    }
...
//                prgDialog.hide();
                ...
                try {
                    ...
                    if(obj.getString("EMAIL")!= "null"){
                        ...
                        list = (ListView) getActivity().findViewById(R.id.SmsStatusList);
